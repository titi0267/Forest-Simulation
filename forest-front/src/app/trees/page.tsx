    ...
    const getForest = async () => {
        try {
            ...
            if (response.data["success"] === true) {
                ...
                const dataWithIds = response.data.message.slice(0, 50000).map((item: any, index: number) => ({ id: index + 1, ...item }));
                setData(dataWithIds);
            }
        } catch (error) {
                ...
                return (
                    <div className="relative flex gap-2">
                        <Dropdown>
                            ...
                            <DropdownMenu>
                                <DropdownItem onPress={() => console.log(data)}>View</DropdownItem>
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span style={{ position: 'relative', left: '10px' }} className="text-default-400 text-small">Total {datas.length} trees</span>
                    <label style={{ position: 'relative', right: '10px' }} className="flex items-center text-default-400 text-small">
                        Rows per page:
                        <select
