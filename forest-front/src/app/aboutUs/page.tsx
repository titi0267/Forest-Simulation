...
const AboutUs = () => {
  const team = [
    {
      avatar: "/images/man_avatar.jpeg",
      name: "Thomas Willson",
      title: "Developer",
      linkedin: "https://www.linkedin.com/in/thomas-willson-5a8b31207/",
      github: "https://github.com/twillsonepitech",
    },
    {
      avatar: "/images/man_avatar.jpeg",
      name: "Timothe Coniel",
      title: "Developer",
      linkedin: "https://www.linkedin.com/in/timoth%C3%A9-coniel-b57341203/",
      github: "https://github.com/titi0267",
    },
    {
      avatar: "/images/man_avatar.jpeg",
      name: "Antoine Gavira-Bottari",
      title: "Developer",
      linkedin: "https://www.linkedin.com/in/antoine-gavira-bottari-3b2671214/",
      github: "https://github.com/Antweneee",
    },
    {
      avatar: "/images/man_avatar.jpeg",
      name: "Hazeem",
      ...
      github: "https://github.com/HezzyHappy",
    },
    {
      avatar: "/images/man_avatar.jpeg",
      name: "Toha",
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          ...
          <div className="mt-12">
            <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {
                team.map((item, idx) => (
                  <li style={{ borderRadius: '10px', background: '#f5f5f5' }} key={idx} className="flex gap-4 items-center">
