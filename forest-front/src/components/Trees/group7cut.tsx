...
const Group7Cut = ({x = -1, y = -1, realX = -1, realY=-1, status="fucked up"}) => {
  const handleHover = () => {
    console.log('---------Group7 Cut tree hovered!---------');
    console.log("x: ", x);
    console.log("y: ", y);
      ...
      >
        ...
        <path
          ...
          style={{
            ...
            strokeLinejoin: "miter",
            strokeMiterlimit: 10,
            fill: "rgb(255, 20, 20)", // lighter red
            fillRule: "nonzero",
            opacity: 1,
          }}
          transform="matrix(1 0 0 1 0 0)"
