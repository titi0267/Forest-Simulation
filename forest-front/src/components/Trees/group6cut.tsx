...
const Group6Cut = ({x = -1, y = -1, realX = -1, realY=-1, status="fucked up"}) => {
  const handleHover = () => {
    console.log('---------Group6 Cut tree hovered!---------');
    console.log("x: ", x);
    console.log("y: ", y);
